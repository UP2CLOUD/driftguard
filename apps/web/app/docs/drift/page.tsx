  ...
  return (
    <MarketingPageShell eyebrow={t("docs.drift.eyebrow")} title={t("docs.drift.title")} subtitle={t("docs.drift.subtitle")} narrow>
      <div className="space-y-8 text-[13px] leading-relaxed text-[color:var(--dg-fg-muted)]">
        ...
        <div><h2 className="text-[15px] font-semibold text-[color:var(--dg-fg)] mb-2">AWS integration</h2>
...
aws_region: eu-west-1`}</pre></div>
        <div><h2 className="text-[15px] font-semibold text-[color:var(--dg-fg)] mb-2">Without AWS access</h2>
