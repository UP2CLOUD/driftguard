...
const EVENTS = [
  {
    ...
    desc: "docs.webhooks.event_analysisCompleted",
    payload: `{
  ...
  {
    name: "policy.blocked",
    desc: "docs.webhooks.event_policyBlocked",
    payload: `{
  ...
  {
    name: "drift.detected",
    desc: "docs.webhooks.event_driftDetected",
    payload: `{
...
export default async function Webhooks() {
  ...
  return (
    <MarketingPageShell
      jsonLd={jsonLdBreadcrumb([{ name: "Home", path: "/" }, { name: "Docs", path: "/docs" }, { name: t("docs.webhooks.title"), path: "/docs/webhooks" }])}
    ...
    >
      <div className="space-y-10">
        ...
        <section className="space-y-3 text-[13px] leading-relaxed text-[color:var(--dg-fg-muted)]">
          ...
          <p>
            {t("docs.webhooks.setupBodyIntro")} <strong className="text-[color:var(--dg-fg)]">{t("docs.webhookPath")}</strong> {t("docs.webhooks.setupBodyMiddle")}
            ...
            {t("docs.webhooks.setupBodyOutro")}
          </p>
          ...
          <div className="space-y-6">
            {EVENTS.map((e) => (
              <div key={e.name} className="rounded-md border border-[color:var(--dg-border)] overflow-hidden">
                ...
                <div className="px-4 py-3 text-[12px] text-[color:var(--dg-fg-muted)] border-b border-[color:var(--dg-border)]">{t(e.desc)}</div>
