    ...
    <main className="min-h-screen bg-zinc-950 text-zinc-100 flex flex-col">
      <div className="flex flex-1 items-center justify-center px-[var(--dg-space-page-x)] py-16">
        <div className="dg-panel max-w-md w-full p-8 text-center">
          <h1 className="text-2xl font-bold tracking-tight text-zinc-100">Analysis not found</h1>
          <p className="mt-2 text-sm leading-relaxed text-zinc-400">This analysis does not exist or is no longer available.</p>
