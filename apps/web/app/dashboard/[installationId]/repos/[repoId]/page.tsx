        ...
        <div className="flex items-center gap-3">
          ...
          {repo?.full_name && (
            <a
              ...
              className="inline-flex items-center gap-1.5 rounded border border-[color:var(--dg-border)] bg-[color:var(--dg-surface)] px-3 py-1.5 font-sans font-medium text-[11px] text-[color:var(--dg-fg-subtle)] hover:text-[color:var(--dg-fg)] hover:border-[color:var(--dg-fg-subtle)] transition"
            >
              ...
              {t("repos.viewOnGitHub") ?? "View on GitHub"}
            </a>
          )}
        </div>
      </div>
