  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between mb-4">
        ...
        <span className="font-sans font-medium text-[10px] uppercase tracking-widest text-[color:var(--dg-fg-subtle)] border border-[color:var(--dg-border)] px-1.5 py-0.5 rounded group-hover:border-[color:var(--dg-border-strong)] group-hover:text-[color:var(--dg-fg-subtle)] transition-colors duration-300">
          {tag}
        </span>
      </div>
