...
async def scan_directory(root: Path) -> ScanResult:
    ...
    """
    from driftguard_cli.scanner.rules.github_actions import scan_gha_files
    from driftguard_cli.scanner.rules.kubernetes import scan_k8s_files
    from driftguard_cli.scanner.rules.terraform import scan_tf_files
