...
def test_compute_risk_caps_at_100():
    ...
    findings = [
        Finding(type="security", severity="critical", resource=f"r{i}",
                message="x", suggestion=None, controls=())
        for i in range(10)
    ]
...
def test_compute_risk_unknown_severity():
    ...
    findings = [
        Finding(type="misc", severity="unknown", resource="r", message="x", suggestion=None, controls=())
    ]
