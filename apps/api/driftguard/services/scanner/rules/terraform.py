...
def scan_tf_files(files: list[Path], root: Path) -> tuple[list[ScanFinding], list[str]]:
    """Scan Terraform files, collecting per-file failures rather than dropping them.
